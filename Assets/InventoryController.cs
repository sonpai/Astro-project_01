...
////    [Header("Item Drop")]
////    [SerializeField] private GameObject groundItemPrefab; // Assign your ground item prefab here
...
////    public List<InventorySlot> InventorySlots_ReadOnly => _inventorySlots;
...
////                {
////                    int space = item.maxStackSize - _inventorySlots[i].quantity;
...
////                OnInventorySlotUpdated?.Invoke(i, item, quantity);
////                SaveInventory();
////                return true;
////            }
////        }
...
////        droppedItemObj.GetComponent<ItemPickup>().Initialize(data, quantity);
...
//            else
//            {
//                OnInventoryRefreshed?.Invoke(); // Refresh UI data right before showing
//                _currentInventoryUI.Show();
//            }
//        }
//    }
...
//    public bool AddItem(ItemData item, int quantity = 1)
//    {
//        // Add logic here from your old script (stacking, then finding empty slots)
//        // For simplicity, this version just finds the first empty slot.
//        for (int i = 0; i < inventorySize; i++)
//        {
//            if (_inventorySlots[i].IsEmpty())
//            {
//                _inventorySlots[i].itemID = item.itemID;
//                _inventorySlots[i].quantity = quantity;
//                OnInventorySlotUpdated?.Invoke(i, item, quantity); // Fire event
//                SaveInventory();
//                return true;
//            }
//        }
...
//        _inventorySlots[indexA] = _inventorySlots[indexB];
//        _inventorySlots[indexB] = temp;
//        OnInventoryRefreshed?.Invoke(); // Easiest to just refresh the whole UI
//        SaveInventory();
//    }
...
//    [ContextMenu("DEBUG: Add Starting Items")]
//    private void Debug_AddItems()
//    {
//        // Make sure the ItemDataManager is ready
//        if (ItemDataManager.Instance == null)
//        {
//            Debug.LogError("ItemDataManager is not ready!");
//            return;
//        }

//        // Add items by their string ID. Make sure these IDs match your ItemData assets.
//        AddItem(ItemDataManager.Instance.GetItemByID("1"), 5);
//        AddItem(ItemDataManager.Instance.GetItemByID("2"), 10);
//        AddItem(ItemDataManager.Instance.GetItemByID("3"), 3);
